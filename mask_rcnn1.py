...
for i in range(0, boxes.shape[2]):
	...
	if confidence > args["confidence"]:
		...
		imageio.imwrite('crop.jpg', crop_img)
		

		img22 = cv2.blur(image,(7,7))
		img22[y:y+h, x:x+w]=crop_img
		imageio.imwrite('result.jpg', img22)
		...
		if args["visualize"] > 0:
			...
			#cv2_imshow(visMask)
			#cv2_imshow(instance)
			imageio.imwrite('final1.jpg', roi)
			imageio.imwrite('final2.jpg', visMask)
			imageio.imwrite('final3.jpg', instance)
		...
		imageio.imwrite('final.jpg', clone)
